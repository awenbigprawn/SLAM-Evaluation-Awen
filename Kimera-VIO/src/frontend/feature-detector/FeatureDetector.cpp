...
FeatureDetector::FeatureDetector(
    ...
    /*,DebugTrackerInfo& debug_info*/) // AwenProblem!
...
KeypointsCV FeatureDetector::featureDetection(const Frame& cur_frame,
  ...
  // don't consider.
  auto start_time_tic = utils::Timer::tic();//-----------------------------------------------------\tic
  ...
  debug_info_.Feature_Detection_First_Part_ = utils::Timer::toc(start_time_tic).count();
  //std::cout << "Feature_Detection_First_Part:" << debug_info_.Feature_Detection_First_Part_<<std::endl; //-----/toc
  start_time_tic = utils::Timer::tic();//------------------------------------------------------\tic
  ...
  debug_info_.Feature_Detection_Second_Part_ = utils::Timer::toc(start_time_tic).count();
  //std::cout << "Feature_Detection_Second_Part:" << debug_info_.Feature_Detection_Second_Part_ <<std::endl; //-----/toc
  ...
  debug_info_.Feature_Detection_Third_Part_ = utils::Timer::toc(start_time_tic).count();
  //std::cout << "Feature_Detection_Third_Part:" << debug_info_.Feature_Detection_Third_Part_ <<std::endl; //-----/toc
  start_time_tic = utils::Timer::tic();//------------------------------------------------------\tic
  ...
  debug_info_.Feature_Detection_Fourth_Part_ = utils::Timer::toc(start_time_tic).count();
  //std::cout << "Feature_Detection_fourth_Part:" << debug_info_.Feature_Detection_Fourth_Part_ <<std::endl; //-----/toc
  start_time_tic = utils::Timer::tic();//------------------------------------------------------\tic
  ...
  //}
  debug_info_.Feature_Detection_Fifth_Part_ = utils::Timer::toc(start_time_tic).count();
  //std::cout << "Feature_Detection_Fifth_Part:" << debug_info_.Feature_Detection_Fifth_Part_ <<std::endl; //-----/toc
