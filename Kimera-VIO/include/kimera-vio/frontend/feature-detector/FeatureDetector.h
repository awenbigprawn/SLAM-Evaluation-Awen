...
#include "kimera-vio/frontend/Tracker-definitions.h"// AwenProblem!
...
class FeatureDetector {
 public:
  ...
  FeatureDetector(const FeatureDetectorParams& feature_detector_params/*, 
                  DebugTrackerInfo& debug_info_*/); // AwenProblem!
  virtual ~FeatureDetector() = default;

 public:
  void featureDetection(Frame* cur_frame);

  inline DebugTrackerInfo getFeatureDetectorDebugInfo() { return debug_info_; }
