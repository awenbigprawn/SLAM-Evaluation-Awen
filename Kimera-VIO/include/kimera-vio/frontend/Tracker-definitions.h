...
public:
  ...
  double Feature_Detection_First_Part_ = 0;
  double Feature_Detection_Second_Part_ = 0;
  double Feature_Detection_Third_Part_ = 0;
  double Feature_Detection_Fourth_Part_ = 0;
  double Feature_Detection_Fifth_Part_ = 0;
