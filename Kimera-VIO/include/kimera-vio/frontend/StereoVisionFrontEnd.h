...
class StereoVisionFrontEnd {
 ...
 private:
  ...
  inline DebugTrackerInfo getFeatureDetectorInfo() {
    return feature_detector_->getFeatureDetectorDebugInfo();
  }//AwenProblem!
 ...
 private:
  ...
  //total spin Time
  double totalSpinTime_;
   
  //linie 323 Awen
  double clone_rect_params_time_;
  double feature_tracking_time_;
  double some_between_definition_time_;
  double sparse_stereo_time_;
  double outlierRejectionStereo_time_;
  double feature_detection_in_Traking_processStereoFrame_time_;
  double sparseStereoMatching_time_;
  double get_smart_stereo_meas_time_;
};
