...
class DebugVioInfo {
 public:
  ...
  double backendOptTime_;//Awen: this recorded the total time of VioBackEnd::optimize()
  //double Create_Backend_Output_Payload_time_;//Awen
  //double getMapLmkIdsTo3dPointsInTimeHorizon_time_;//Awen
  double MANAGE_IMU_MEASUREMENTS_time_;
  double MANAGE_VISION_MEASUREMENTS_time_;
  ...
  void resetTimes() {
    ...
    marginalizeTime_ = 0;
    backendOptTime_=0;//Awen
    //Create_Backend_Output_Payload_time_=0;//Awen
    //getMapLmkIdsTo3dPointsInTimeHorizon_time_=0;//Awen
    MANAGE_IMU_MEASUREMENTS_time_=0;//Awen
    MANAGE_VISION_MEASUREMENTS_time_=0;//Awen
  }
  ...
  void printTimes() const {
    LOG(INFO) << "-------- VIO Backend Timing --------\n"
              ...
              << "Total backendOpt Time :" << backendOptTime_ << "\n"//Awen
              //<< "logger use time :" << Create_Backend_Output_Payload_time_ <<"\n"
              //<< "getMapLmkIdsTo3dPointsInTimeHorizon time :" << getMapLmkIdsTo3dPointsInTimeHorizon_time_;//Awen
              << "MANAGE_IMU_MEASUREMENTS_time_ :" <<MANAGE_IMU_MEASUREMENTS_time_//Awen
              << "MANAGE_VISION_MEASUREMENTS_time :"<<MANAGE_VISION_MEASUREMENTS_time_;//Awen
  }
